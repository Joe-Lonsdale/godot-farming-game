...
@onready var planting_interaction_type: InteractionTypeHold = load("res://Entities/Garden/Plot/Data/plot_interaction_planting.tres").duplicate()
@onready var watering_interaction_type: InteractionTypeHold = load("res://Entities/Garden/Plot/Data/plot_interaction_watering.tres").duplicate()
...
var planted_crop: CropItem = null
